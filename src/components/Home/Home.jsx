                ...
                <div className="col-sm-8 shadow mx-auto bootstrap snippets post-feed mt-5">
                    ...
                    <div className="panel">
                        ...
                        <div className="media-block">
                            ...
                            <a className="media-left avatar mr-2" href="#">
                                <img className="w-48 img-circle img-sm" alt="Profile Picture" src="https://bootdey.com/img/Content/avatar/avatar1.png"/>
                            </a>
                            ...
                            <div className="media-body">
                                ...
                                <div className="mt-1">
                                    <a className="btn btn-sm btn-default btn-hover-primary p-0"><i className="fa fa-heart-o text-secondary"></i> 250 Likes</a>
                                    <a className="btn btn-sm btn-default btn-hover-primary ml-2" href="#"><u>Comments</u></a>
                                </div>
                                <hr/>
                                ...
                                <div>
                                <div className="media-block">
                                    <a className="media-left avatar mr-2" href="#"><img className="w-48 img-circle img-sm" alt="Profile Picture" src="https://bootdey.com/img/Content/avatar/avatar2.png"/></a>
                                    <div className="media-body">
                                    <div className="mar-btm">
                                    ...
                                    <div className="mt-1">
                                        ...
                                        <a className="btn btn-sm btn-default btn-hover-primary p-0"><i className="fa fa-heart-o text-secondary"></i> 2 Likes</a>
                                ...
                                <div className="media-block">
                                    <a className="media-left avatar mr-2" href="#"><img className="w-48 img-circle img-sm" alt="Profile Picture" src="https://bootdey.com/img/Content/avatar/avatar3.png"/>
                                    </a>
                                    <div className="media-body">
                                    <div className="mar-btm">
                                    ...
                                    <div className="mt-1">
                                            <a className="btn btn-sm btn-default btn-hover-primary p-0">Like</a>
                                    </div>
                                    <hr/>
                                    </div>
                                </div>
